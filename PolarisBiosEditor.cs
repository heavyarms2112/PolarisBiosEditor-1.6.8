    ...
    public partial class PolarisBiosEditor : Form
    {
        ...
        public PolarisBiosEditor()
        {
            ...
            try
            {
                ...
                Stream myStream = myWebClient.OpenRead("https://raw.githubusercontent.com/vasovic/PolarisBiosEditor-1.6.8/master");
                ...
                myStream = myWebClient.OpenRead("https://raw.githubusercontent.com/vasovic/PolarisBiosEditor-1.6.8/master/notice");
            ...
            this.rc.Add("MT51J256M3", "MICRON");
            this.rc.Add("EDW4032BAB", "ELPIDA");
            this.rc.Add("H5GC4H24AJ", "HYNIX_1");
            this.rc.Add("H5GQ4H24AJ", "HYNIX_2");
            this.rc.Add("H5GQ8H24MJ", "HYNIX_2");
            this.rc.Add("H5GC8H24MJ", "HYNIX_3");
            this.rc.Add("K4G80325FB", "SAMSUNG");
            this.rc.Add("K4G41325FE", "SAMSUNG");
            this.rc.Add("K4G41325FC", "SAMSUNG");
            this.rc.Add("K4G41325FS", "SAMSUNG");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (samsung_index != -1)
            {
                MessageBox.Show("Samsung Memory found at index #" + samsung_index + ", now applying UBERMIX 3.2 timings to 1500+ strap(s)");
            ...
            {
                MessageBox.Show("Sorry, no supported memory found. If you think this is an error, please file a bugreport @ github.com/vasovic/PolarisBiosEditor");
            }
